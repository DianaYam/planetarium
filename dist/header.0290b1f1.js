...
$(document).ready(function () {
  $(".header-menu-sign").click(function () {
    $(this).closest('.header').toggleClass('opened').find('.header-menu-list-wrapper').css("width", $(window).width());
  });
  ...
  $(window).resize(function () {
    ...
    if (windowWidth !== width) {
      // (2)
      if (windowWidth <= 750) {
        $('.header-menu-list-wrapper').css("width", windowWidth);
      } else {
        $('.header-menu-list-wrapper').css("width", "");
